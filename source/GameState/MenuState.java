...
public class MenuState extends GameState implements ActionListener
{
  ...
  /** Initializes all the labels and buttons with their pictures. Also activates the labels and buttons.
    ...
    * <li>printImg, ImageIcon, holds the print button image
    * <li>printRollImg, ImageIcon, holds the print button rollover image
    * </ul>
    */
  ...
  /** This method removes the highscore labels.
   */
  ...
  /** This method adds the "print" button.
   */
  ...
  /** This method removes the "print" button.
   */
  ...
  /** This method loads the high scores onto the screen. Button locations and label locations and fonts are set.
    * @param font Font reference variable
    * @param read Scanner variable reading from the scores.txt file
    * @param e Exception reference variable. Can print stack trace or display that the highscore is corrupted if actually corrupted.
   */
